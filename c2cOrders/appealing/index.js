...
function requestData() {
        ...
        <tbody class="table-group-divider">
          ${
            data.length > 0
              ...
              return `
            <tr>
              <td><a href="javascript:void(0)" class="text-primary" onclick="g_data.viewOrderDetail('${item.system_id }')">${item.system_id }</a></td>
              <td>
  ...
  $.ajax({
    url: "/c2cOrders/appealing/list.php",
    type: "GET",
    data: {
...
g_data.viewOrderDetail = function (orderId) {
  ...
  let hash = "/c2cOrders/appealing/info/?id=" + orderId;
